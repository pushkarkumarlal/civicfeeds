        ...
        <StatusBar  backgroundColor="#f0f0f0" barStyle="dark-content"/>
            ...
            <View style={styles.container1}>
                <View style={styles.container1_1}>
                    <Link href='../phonenum/phonenum'>.<Image style={styles.topHeaderBackArrow}source={leftArrow}/></Link></View>
                
                <View style={styles.container1_2}>
                <Image style={styles.otpVerification} source={otpVerificationImage}/>
                    </View>
            </View>
            ...
            <View style={styles.container3}>
               ...
               <Link href='../user-info/user-info'> <Image source={rightArrow}/></Link>
